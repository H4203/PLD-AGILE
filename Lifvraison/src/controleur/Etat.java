...
public interface Etat {
	...
	/**
	 * Methode appelee par controleur apres un clic sur le bouton "Ajouter une Livraison"
	 * @param controleur 
	 * @param fenetre
	 */
	public void ajouterLivraison(Controleur controleur, Fenetre fenetre);
	/**
	 * Methode appelee par controleur apres un clic sur le bouton "Retirer une Livraison"
	 * @param controleur 
	 * @param fenetre
	 */
	public void supprimerLivraison(Controleur controleur, Fenetre fenetre );
	/**
	 * Methode appelee par controleur apres un clic sur le bouton "Echanger 2 Livraisons"
	 * @param controleur 
	 * @param fenetre
	 */
