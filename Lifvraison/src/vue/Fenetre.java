...
public class Fenetre extends JFrame
{
	...
	public Fenetre(Controleur controleur, Plan plan, DemandeLivraison demandeLivraison, Tournee tournee)
	{
		...
		// 1.1.2.2.1 mainPanel/centerPanel/rightPanel/overActionButtonsPanel/actionButtonsPanel
		JPanel actionButtonsPanel = new JPanel();
		actionButtonsPanel.setLayout(new GridLayout(2, 3, 20, 20));
		overActionButtonsPanel.add(actionButtonsPanel);
		
		// 1.1.2.2.1.1 mainPanel/centerPanel/rightPanel/overActionButtonsPanel/actionButtonsPanel/buttonAjouterLivraison
		...
		// 1.1.2.2.1.2 mainPanel/centerPanel/rightPanel/overActionButtonsPanel/actionButtonsPanel/buttonSupprimerLivraison
		...
		// 1.1.2.2.1.3 mainPanel/centerPanel/rightPanel/overActionButtonsPanel/actionButtonsPanel/buttonEchangerLivraisons
		...
		// 1.1.2.2.1.4 mainPanel/centerPanel/rightPanel/overActionButtonsPanel/actionButtonsPanel/buttonUndo
		buttonUndo = new JButton("Annuler");
		buttonUndo.addActionListener(ecouteurDeBoutons);
		actionButtonsPanel.add(buttonUndo);
		// 1.1.2.2.1.5 mainPanel/centerPanel/rightPanel/overActionButtonsPanel/actionButtonsPanel/buttonRedo
	...
	public void setModeModificationTournee(String etat)
	{
		...
		{
			setIndicationLabel("<html>Tournée calculée avec succès<br>Utilisez les boutons de droite pour modifier votre tournee, puis cliquez sur Valider Tournee pour valider votre tournee</html>");
